...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-dark py-3" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="/homepage">Car<span>Book</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="/payments1" class="nav-link">Payment</a></li>
	          <li class="nav-item active"><a href="/cars1" class="nav-link">Cars</a></li>
	          <li class="nav-item"><a href="/homepage" class="nav-link">Log out</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="/homepage">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Cars <i class="ion-ios-arrow-forward"></i></span></p>
    		...
    		<div class="row">
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					<div class="img rounded d-flex align-items-end" style="background-image: url(carbook-master/images/car-1.jpg);">
    					</div>
    					<div class="text">
    						<h2 class="mb-0"><a href="carbook-master/car-single.html">Mercedes Grand Sedan</a></h2>
    						<div class="d-flex mb-3">
	    						<span class="cat">Cheverolet</span>
	    						<p class="price ml-auto">$500 <span>/day</span></p>
    						</div>
    						<p class="d-flex mb-0 d-block"><a href="{{route('rentals1.index')}}" class="btn btn-primary py-2 mr-1">Book now</a> <a href="carbook-master/car-single.html" class="btn btn-secondary py-2 ml-1">Details</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					<div class="img rounded d-flex align-items-end" style="background-image: url(carbook-master/images/car-2.jpg);">
    					</div>
    					<div class="text">
    						<h2 class="mb-0"><a href="carbook-master/car-single.html">Range Rover</a></h2>
    						<div class="d-flex mb-3">
    			...
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					<div class="img rounded d-flex align-items-end" style="background-image: url(carbook-master/images/car-3.jpg);">
    					</div>
    					<div class="text">
    						<h2 class="mb-0"><a href="carbook-master/car-single.html">Jaeger Amland</a></h2>
    						<div class="d-flex mb-3">
	    						<span class="cat">Cheverolet</span>
    			...
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					<div class="img rounded d-flex align-items-end" style="background-image: url(carbook-master/images/car-4.jpg);">
    					</div>
    					<div class="text">
    						<h2 class="mb-0"><a href="carbook-master/car-single.html">Mercedes Dark Series</a></h2>
    						<div class="d-flex mb-3">
	    						<span class="cat">Cheverolet</span>
	    						<p class="price ml-auto">$800 <span>/day</span></p>
    						</div>
    						<p class="d-flex mb-0 d-block"><a href="{{route('rentals1.index')}}" class="btn btn-primary py-2 mr-1">Book now</a> <a href="car-single.html" class="btn btn-secondary py-2 ml-1">Details</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					<div class="img rounded d-flex align-items-end" style="background-image: url(carbook-master/images/car-5.jpg);">
    					</div>
    					<div class="text">
    						<h2 class="mb-0"><a href="car-single.html">BMW Blue</a></h2>
    						<div class="d-flex mb-3">
	    						<span class="cat">BMW</span>
	    						<p class="price ml-auto">$1000 <span>/day</span></p>
    						</div>
    						<p class="d-flex mb-0 d-block"><a href="{{route('rentals1.index')}}" class="btn btn-primary py-2 mr-1">Book now</a> <a href="car-single.html" class="btn btn-secondary py-2 ml-1">Details</a></p>
    					</div>
    				</div>
    			...
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					<div class="img rounded d-flex align-items-end" style="background-image: url(carbook-master/images/car-6.jpg);">
    					</div>
    					<div class="text">
    						<h2 class="mb-0"><a href="car-single.html">Alfa Romeo</a></h2>
    						<div class="d-flex mb-3">
	    						<span class="cat">Cheverolet</span>
	    						<p class="price ml-auto">$750 <span>/day</span></p>
    						</div>
    						<p class="d-flex mb-0 d-block"><a href="{{route('rentals1.index')}}" class="btn btn-primary py-2 mr-1">Book now</a> <a href="carbook-master/car-single.html" class="btn btn-secondary py-2 ml-1">Details</a></p>
    					</div>
    				</div>

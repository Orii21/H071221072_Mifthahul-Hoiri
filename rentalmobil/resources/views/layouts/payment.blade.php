	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="{{route('payments1.index')}}" class="nav-link">Payment</a></li>
	          <li class="nav-item"><a href="{{route('cars1.index')}}" class="nav-link">Cars</a></li>
